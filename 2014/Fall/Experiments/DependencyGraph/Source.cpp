...
class AdditionOperationNode : public BinaryOperationNode {
public:
	AdditionOperationNode() {}
	AdditionOperationNode(string name, Node * param1, Node * param2)
...
class SubtractionOperationNode : public BinaryOperationNode {
public:
	SubtractionOperationNode(){}
	SubtractionOperationNode(string name, Node * param1, Node * param2)
		: BinaryOperationNode(name, param1, param2)
	{}
	double evaluate() {
		return param1->evaluate() - param2->evaluate();
...
class PowerOperationNode : public BinaryOperationNode {
public:
	PowerOperationNode(){}
	PowerOperationNode(string name, Node * param1, Node * param2)
		: BinaryOperationNode(name, param1, param2)
	{}
	double evaluate() {
		return pow(param1->evaluate(), param2->evaluate());
	}
};
class SquareRootOperationNode : public UnaryOperationNode {
public:
	SquareRootOperationNode(){}
	SquareRootOperationNode(string name, Node * param)
		: UnaryOperationNode(name, param)
	{}
	double evaluate() {
		return sqrt(param->evaluate());
	}
};
